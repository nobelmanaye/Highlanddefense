...
class Vector2(object):
   ...
   def __mul__(self, other):
      ...
      raise Exception("Unknown Multiplication Type: " + str(type(other)))
   ...
   def __truediv__(self, other):
      ...
      raise Exception("Unknown Division Type: " + str(type(other)))
   ...
   def __add__(self, other):
      ...
      if type(other) in [type(self), list]:
         clone = Vector2(*self)
         clone[0] += other[0]
         clone[1] += other[1]
      ...
      raise Exception("Unknown Addition Type: " + str(type(other)))
   ...
   def __sub__(self, other):
      ...
      raise Exception("Unknown Subtraction Type: " + str(type(other)))
